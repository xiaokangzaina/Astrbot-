...
## 重要变更：v1.8.3 无 Web 面板

本插件不再提供前端 Web 设置面板，请使用 AstrBot 插件配置页或配置文件维护配置。
...
安装包名称：astrbot_plugin_permission_controller-v1.8.3.zip

Release 地址：

https://github.com/xiaokangzaina/astrbot_plugin_permission_controller/releases/tag/v1.8.3
...
因为 Web 面板在部分 AstrBot Dashboard 环境下会出现路由不兼容，导致保存失败。当前版本使用 AstrBot 插件配置页或配置文件维护。
