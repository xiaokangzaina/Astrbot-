...
安装包名称：astrbot_plugin_permission_controller-v1.8.1.zip

Release 地址：

https://github.com/xiaokangzaina/astrbot_plugin_permission_controller/releases/tag/v1.8.1
...
- 回退 v1.8.0 的配置分组改动，恢复默认平铺配置，避免部分环境下插件配置失效。
